...
class User(UserMixin, db.Model):
    ...
    match_entries = Relationship("MatchPlayer", back_populates="user")

    # tournaments this user is hosting
    hosted_tournaments = Relationship(
        "Tournament", foreign_keys="Tournament.host_user_id", back_populates="host"
    )
    ...
    leaderboard_rank = Relationship("Leaderboard", back_populates="user", uselist=False)
...
class OTP(db.Model):
    ...
    user = Relationship("User", back_populates="otp_code", uselist=False)
...
class Tournament(db.Model):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    tournament_code: Mapped[String] = mapped_column(
    ...
    host = Relationship(
        "User", back_populates="hosted_tournaments", foreign_keys=[host_user_id]
    )
...
class Leaderboard(db.Model):
    ...
    user = Relationship("User", back_populates="leaderboard_rank", uselist=False)
